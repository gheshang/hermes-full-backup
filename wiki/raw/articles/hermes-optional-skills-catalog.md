...
# Optional Skills Catalog (Raw)

Total: 57 skills / 14 categories
...
- **peft-fine-tuning** — Parameter-efficient fine-tuning for LLMs using LoRA, QLoRA, and 25+ methods. Train <1% of parameters with minimal accuracy loss.
...
- **stable-diffusion-image-generation** — State-of-the-art text-to-image generation with Stable Diffusion via HuggingFace Diffusers.
