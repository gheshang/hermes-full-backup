---
title: Hermes MCP Config Reference
created: 2026-04-24
updated: 2026-04-24
type: concept
tags: [hermes, mcp, reference, config]
sources: [raw/articles/hermes-mcp-config.md]
---

# Hermes MCP Config Reference

源文档：[Hermes MCP Config Reference](https://hermes-agent.nousresearch.com/docs/reference/mcp-config-reference)
...
For example, a server named `my-api` exposing a tool...
...
- Only applies to HTTP/StreamableHTTP transport (`url`-bas...
