...
type: concept
tags: ["concept"]
sources: [raw/articles/features-acp.md]
---

# ACP Editor Integration

源文档：[ACP Editor Integration](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/acp.md)
