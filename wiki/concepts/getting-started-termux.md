...
type: concept
tags: ["concept"]
sources: [raw/articles/getting-started-termux.md]
---

# Hermes on Android with Termux

源文档：[Hermes on Android with Termux](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/getting-started/termux.md)
...
```bash
git clone --recurse-submodules https://github.com/NousR...
