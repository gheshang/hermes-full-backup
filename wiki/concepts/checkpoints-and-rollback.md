...
type: concept
tags: ["concept"]
sources: [raw/articles/checkpoints-and-rollback.md]
---

# Checkpoints and `/rollback`

源文档：[Checkpoints and `/rollback`](https://raw.githubusercontent.com/NousResearch/hermes-agent/main/website/docs/user-guide/checkpoints-and-rollback.md)
