...
type: concept
tags: ["concept"]
sources: [raw/articles/features-tool-gateway.md]
---

# Nous Tool Gateway

源文档：[Nous Tool Gateway](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/tool-gateway.md)
...
| **Browser automation** | Control cloud browsers via Browser Use | `BROWSER_...
...
These env vars are always visible in the configuration regardless of subscription status — they're useful for custom infrastructu...
...
Tools that were routed through the gateway w...
