...
type: concept
tags: ["concept"]
sources: [raw/articles/guides-use-voice-mode-with-hermes.md]
---

# Use Voice Mode with Hermes

源文档：[Use Voice Mode with Hermes](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/guides/use-voice-mode-with-hermes.md)
