...
updated: 2026-04-24
type: concept
tags: [hermes, commands, reference]
sources: [raw/articles/hermes-slash-commands.md]
---

# Hermes Slash Commands Reference

源文档：[Hermes Slash Commands Reference](https://hermes-agent.nousresearch.com/docs/reference/slash-commands)
...
- `/status`, `/background`, `/voice`, `/reload-mcp`, `/rollback`, `/snapshot`,...
