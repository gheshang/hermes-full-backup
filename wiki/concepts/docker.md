...
type: concept
tags: ["concept"]
sources: [raw/articles/docker.md]
---

# Hermes Agent — Docker

源文档：[Hermes Agent — Docker](https://raw.githubusercontent.com/NousResearch/hermes-agent/main/website/docs/user-guide/docker.md)
...
Opening any port on an internet facing machine is a security risk. ...
...
Replace `$HOST_IP` with the IP address of the machine running the gateway container (e.g. `192.168.1.100`), or use a Docker network hostname if both containers share ...
...
:::warning
Never run two Hermes **gateway** containers agains...
