...
type: concept
tags: ["concept"]
sources: [raw/articles/developer-guide-adding-tools.md]
---

# Adding Tools

源文档：[Adding Tools](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/developer-guide/adding-tools.md)
