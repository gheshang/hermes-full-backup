...
type: concept
tags: ["concept"]
sources: [raw/articles/git-worktrees.md]
---

# Git Worktrees

源文档：[Git Worktrees](https://raw.githubusercontent.com/NousResearch/hermes-agent/main/website/docs/user-guide/git-worktrees.md)
...
- Hermes checkpoint data under `~/.he...
...
- **Avoid running Hermes from the bare repo root when using worktrees**
  - Prefer the worktree directories instead, so each a...
