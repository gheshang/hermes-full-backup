...
type: concept
tags: ["concept"]
sources: [raw/articles/developer-guide-architecture.md]
---

# Architecture

源文档：[Architecture](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/developer-guide/architecture.md)
...
8. **[Gateway Internals](./gateway-inte...
...
- **`prompt_builder.py`** — Assembles the system prompt from: personality (SOUL.md), memory (MEMORY.md, USER.md), skills, context files (AGENTS.md, .hermes.md), tool-use guidance, and model-specific...
...
| **Platform-agnostic core** | One AIAgent class serves CLI, gateway, ACP, batch, and API server. Platform differences ...
