...
type: concept
tags: ["concept"]
sources: [raw/articles/reference-tools-reference.md]
---

# Built-in Tools Reference

源文档：[Built-in Tools Reference](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/reference/tools-reference.md)
