...
type: concept
tags: ["concept"]
sources: [raw/articles/release-note-v531-en.md]
---

# CC Switch CLI v5.3.1

源文档：[CC Switch CLI v5.3.1](https://raw.githubusercontent.com/SaladDay/cc-switch-cli/main/docs/release-note-v5.3.1-en.md)
