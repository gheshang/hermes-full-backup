...
type: concept
tags: ["concept"]
sources: [raw/articles/reference-mcp-config-reference.md]
---

# MCP Config Reference

源文档：[MCP Config Reference](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/reference/mcp-config-reference.md)
