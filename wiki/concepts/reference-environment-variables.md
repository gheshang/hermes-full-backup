...
type: concept
tags: ["concept"]
sources: [raw/articles/reference-environment-variables.md]
---

# Environment Variables Reference

源文档：[Environment Variables Reference](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/reference/environment-variables.md)
