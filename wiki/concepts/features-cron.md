...
type: concept
tags: ["concept"]
sources: [raw/articles/features-cron.md]
---

# Scheduled Tasks (Cron)

源文档：[Scheduled Tasks (Cron)](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/cron.md)
...
hermes cron edit <job_id> --remove-skill blogw...
...
Scheduled task prompts are scanned for prompt-injection and credential-exfilt
