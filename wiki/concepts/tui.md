...
type: concept
tags: ["concept"]
sources: [raw/articles/tui.md]
---

# TUI

源文档：[TUI](https://raw.githubusercontent.com/NousResearch/hermes-agent/main/website/docs/user-guide/tui.md)
...
The classic CLI remains available as the default. Anything documented in [CLI Interface](cli.md) — s...
...
- **Mouse-friendly selection** — drag to highlight with a uniform background instead of SGR inv...
...
Distributions that ship a prebuilt bundle (Nix, system packages) can point Hermes at ...
...
The per-skin status-bar colors and thresholds are shared with the classic CLI — see [Skins](featur...
