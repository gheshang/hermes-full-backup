...
type: concept
tags: ["concept"]
sources: [raw/articles/features-personality.md]
---

# Personality & SOUL.md

源文档：[Personality & SOUL.md](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/personality.md)
