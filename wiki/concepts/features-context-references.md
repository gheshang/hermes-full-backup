...
type: concept
tags: ["concept"]
sources: [raw/articles/features-context-references.md]
---

# Context References

源文档：[Context References](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/context-references.md)
