...
type: concept
tags: ["concept"]
sources: [raw/articles/guides-use-mcp-with-hermes.md]
---

# Use MCP with Hermes

源文档：[Use MCP with Hermes](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/guides/use-mcp-with-hermes.md)
...
mcp_servers:
  stripe:
    ...
    tools:
      exclude: [delete_customer, refund_pay...
...
Because Hermes now respects your per-server policy and capabi...
