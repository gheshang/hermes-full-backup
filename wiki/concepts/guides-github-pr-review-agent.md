...
type: concept
tags: ["concept"]
sources: [raw/articles/guides-github-pr-review-agent.md]
---

# Tutorial: Build a GitHub PR Review Agent

源文档：[Tutorial: Build a GitHub PR Review Agent](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/guides/github-pr-review-agent.md)
...
These memories persist forever — the reviewer will enforc...
...
### Rate limits
GitHub allows 5,000 API requests/hour for authenticated users. Each PR review uses ~3-5 requests (list + diff + optional commen...
